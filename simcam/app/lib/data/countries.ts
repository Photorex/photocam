...
/**
 * Gets the full country name from a two-letter ISO code.
 * @param code The two-letter ISO country code (e.g., "US").
 * @returns The full country name (e.g., "United States") or the code itself if not found.
 */
